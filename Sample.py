...
def db_con(c20,tn):
    ...
    d_b1 = mc.connect(
        host="localhost",
        user="root",
        password="sharvesh1234",
        database="details1"
    )
    c1 = d_b1.cursor()
    c1.execute("INSERT INTO customer_details1 (name,mobilenum,address,product_name,quantity,size,total) VALUES ( %s,%s,%s,%s,%s,%s,%s)",
                   (n,m,a,t,q1,s,c))
    d_b1.commit()
...
def frame0():
    ...
    pic1 = Image.open(img1)
    photo1 = ImageTk.PhotoImage(pic1)
    label0 = tk.Label(f, image=photo1, bg="light steel blue")
    label0.image = photo1
    label0.place(x=0, y=-500)
    ...
    r1 = tk.Button(f, text='REGISTER', font=('bold', 12), bg='red', fg='white', command=lambda: [(clear(),register())])
...
def address_mm1():
    global ea,ea1,ea2,ea3,q,ea4,tn
    ...
    tn= tk.Label(f, text='Men Black Formal Moccasin', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,"Men Black Formal Moccasin"))])
    c.place(x=646, y=440)
...
def address_mm2():
    ...
    tn = tk.Label(f, text='Men Black Ethnic Slippers', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,'Men Black Ethnic Slippers'))])
    c.place(x=646, y=440)
...
def address_ww1():
    ...
    tn= tk.Label(f, text='Women Black Formal Pumps', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,'Women Black Formal Pumps'))])
    c.place(x=646, y=440)
...
def address_ww2():
    ...
    tn= tk.Label(f, text='Women Peach Casual Sandals', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,'Women Peach Casual Sandals'))])
    c.place(x=646, y=440)
...
def address_kk1():
    ...
    tn = tk.Label(f, text='Boys Blue Casual Loafers', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,'Boys Blue Casual Loafers'))])
    c.place(x=646, y=440)
...
def address_kk2():
    ...
    tn = tk.Label(f, text='Girls Gold Casual Ballerinas', font='bold', width=50)
    tn.place(x=480, y=160)

    c= tk.Button(f, text='CONFIRM ORDER',font=('bold',10), bg='red',fg='white',command=lambda: [(confirm_order(),db_con(q_3,'Girls Gold Casual Ballerinas'))])
    c.place(x=646, y=440)
